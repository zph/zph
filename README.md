...
- [jdx/mise](https://github.com/jdx/mise) ([v2024.9.3](https://github.com/jdx/mise/releases/tag/v2024.9.3), 3 days ago) - dev tools, env vars, task runner
- [dagu-org/dagu](https://github.com/dagu-org/dagu) ([v1.14.4](https://github.com/dagu-org/dagu/releases/tag/v1.14.4), 4 days ago) - Developer-friendly, minimalism Cron alternative, but with much more capabilities. It aims to solve greater problems.
...
- [samber/slog-multi](https://github.com/samber/slog-multi) - 🚨 Design workflows of slog handlers: pipeline, middleware, fanout, routing, failover, load balancing... (1 day ago)
