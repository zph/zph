...
- [Deno for Shell Scripting a Pagerduty helper](https://blog.xargs.io/post/2023-04-12-deno-for-shell-scripting-a-pagerduty-helper/) (5 days ago)
...
- [zph/homebrew-zph](https://github.com/zph/homebrew-zph) -  (3 days ago)
...
- [Update README.md to include alternate execution method](https://github.com/japiirainen/vl/pull/1) on [japiirainen/vl](https://github.com/japiirainen/vl) (2 days ago)
- [Update README.md to include alternate execution method](https://github.com/zph/vl/pull/1) on [zph/vl](https://github.com/zph/vl) (2 days ago)
- [ISSUE 3: Fix env variable merging](https://github.com/zph/chain/pull/6) on [zph/chain](https://github.com/zph/chain) (3 weeks ago)

#### 📓 Gists

- [](https://gist.github.com/790e9259a9afa4ab7741a493994d8fa8) (5 days ago)
...
- [freescout-helpdesk/freescout](https://github.com/freescout-helpdesk/freescout) - FreeScout — Free self-hosted help desk &amp; shared mailbox (Zendesk / Help Scout alternative) (1 day ago)
- [wabarc/wayback](https://github.com/wabarc/wayback) - A self-hosted archiving service with an IM-style interface, integrated with various archival services including Internet Archive, archive.today, IPFS, Telegraph, and file systems. (2 days ago)
