...
- [jdx/mise](https://github.com/jdx/mise) ([v2025.1.2](https://github.com/jdx/mise/releases/tag/v2025.1.2), 1 day ago) - dev tools, env vars, task runner
- [denoland/deno](https://github.com/denoland/deno) ([v2.1.4](https://github.com/denoland/deno/releases/tag/v2.1.4), 4 weeks ago) - A modern runtime for JavaScript and TypeScript.
- [dagu-org/dagu](https://github.com/dagu-org/dagu) ([v1.15.1](https://github.com/dagu-org/dagu/releases/tag/v1.15.1), 1 month ago) - Developer-friendly, minimalism Cron alternative, but with much more capabilities. It aims to solve greater problems.
...
- [jeremiah-shaulov/diff_kit](https://github.com/jeremiah-shaulov/diff_kit) - Deno lib that compares 2 strings and generates result like assertEquals(), also in HTML (1 day ago)
