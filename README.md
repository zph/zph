...
- [daguflow/dagu](https://github.com/daguflow/dagu) ([v1.14.3](https://github.com/daguflow/dagu/releases/tag/v1.14.3), 2 days ago) - Developer-friendly, minimalism Cron alternative, but with much more capabilities. It aims to solve greater problems.
- [jdx/mise](https://github.com/jdx/mise) ([v2024.8.6](https://github.com/jdx/mise/releases/tag/v2024.8.6), 4 days ago) - dev tools, env vars, task runner
