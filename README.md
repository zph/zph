...
- [ankur-anand/unisondb](https://github.com/ankur-anand/unisondb) - A log-native database that replicates like a message bus — purpose-built for distributed, edge-scale systems. (1 week ago)
