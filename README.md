...
- [zph/data-diff](https://github.com/zph/data-diff) - Fork of datafold/data-diff (2 days ago)
- [zph/hermit-packages](https://github.com/zph/hermit-packages) - hermit package declarations (2 days ago)
- [pingcap/tiup](https://github.com/pingcap/tiup) - A component manager for TiDB (5 days ago)
...
- [denoland/deno](https://github.com/denoland/deno) ([v1.45.4](https://github.com/denoland/deno/releases/tag/v1.45.4), 1 day ago) - A modern runtime for JavaScript and TypeScript.
- [daguflow/dagu](https://github.com/daguflow/dagu) ([v1.14.1](https://github.com/daguflow/dagu/releases/tag/v1.14.1), 5 days ago) - Yet another cron alternative with a Web UI, but with much more capabilities. It aims to solve greater problems.
- [jdx/mise](https://github.com/jdx/mise) ([v2024.7.4](https://github.com/jdx/mise/releases/tag/v2024.7.4), 1 week ago) - dev tools, env vars, task runner
...
- [jupyterlab-contrib/jupyterlab-kernelspy](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) - A Jupyter Lab extension for inspecting messages to/from a kernel (1 day ago)
