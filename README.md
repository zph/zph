...
- [jdx/mise](https://github.com/jdx/mise) ([v2025.3.0](https://github.com/jdx/mise/releases/tag/v2025.3.0), 1 day ago) - dev tools, env vars, task runner
- [dagu-org/dagu](https://github.com/dagu-org/dagu) ([v1.16.4](https://github.com/dagu-org/dagu/releases/tag/v1.16.4), 5 days ago) - A compact, portable, and language-agnostic workflow engine. It aims to solve greater problems.
- [denoland/deno](https://github.com/denoland/deno) ([v2.2.2](https://github.com/denoland/deno/releases/tag/v2.2.2), 5 days ago) - A modern runtime for JavaScript and TypeScript.

#### 🔨 My recent Pull Requests

- [Zh get tests running](https://github.com/zph/session-manager-plugin/pull/1) on [zph/session-manager-plugin](https://github.com/zph/session-manager-plugin) (6 days ago)
- [zh move to ruff](https://github.com/zph/runbook/pull/27) on [zph/runbook](https://github.com/zph/runbook) (3 weeks ago)
...
- [chalk-ai/examples](https://github.com/chalk-ai/examples) - Curated examples and patterns for using Chalk. Use these to build your feature pipelines. (1 day ago)
- [langfuse/langfuse](https://github.com/langfuse/langfuse) - 🪢 Open source LLM engineering platform: LLM Observability, metrics, evals, prompt management, playground, datasets. Integrates with OpenTelemetry, Langchain, OpenAI SDK, LiteLLM, and more. 🍊YC W23  (1 day ago)
