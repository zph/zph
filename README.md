...
- [dagu-org/dagu](https://github.com/dagu-org/dagu) ([v1.17.0](https://github.com/dagu-org/dagu/releases/tag/v1.17.0), today) - A self-contained, powerful workflow engine, alternative to Airflow, Cron, etc. It aims to solve greater problems.
