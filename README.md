...
- [dagu-org/dagu](https://github.com/dagu-org/dagu) ([v1.17.0-beta.13](https://github.com/dagu-org/dagu/releases/tag/v1.17.0-beta.13), today) - A self-contained, light-weight, and language-agnostic workflow engine, alternative to Airflow, Cron, etc. It aims to solve greater problems.
