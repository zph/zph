...
- [agentika-labs/grepika](https://github.com/agentika-labs/grepika) -  (1 day ago)
- [mickamy/sql-tap](https://github.com/mickamy/sql-tap) - Watch SQL traffic in real-time with a TUI (1 day ago)
- [boxlite-ai/boxlite](https://github.com/boxlite-ai/boxlite) - Local-first sandbox for AI agents. (2 days ago)
