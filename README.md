...
- [Hugo to 0.105.0](https://blog.xargs.io/post/2022-11-05-try-out-mermaid/) (10 months ago)
...
- [toumorokoshi/tome](https://github.com/toumorokoshi/tome) ([v0.10.0](https://github.com/toumorokoshi/tome/releases/tag/v0.10.0), 1 day ago) - convert any directory of scripts into your own fully-featured command.
...
- [nginx/unit](https://github.com/nginx/unit) - NGINX Unit - universal web app server - a lightweight and versatile open source server that simplifies the application stack by natively executing application code across eight different programming language runtimes. (3 days ago)
- [hotelcaliforniabm/arc](https://github.com/hotelcaliforniabm/arc) - Modular off grid solar power system (4 days ago)
