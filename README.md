...
- [zdk/lowfat](https://github.com/zdk/lowfat) - lowfat - slim your command output. strips noise, saves tokens. (2 days ago)
- [microsoft/duroxide](https://github.com/microsoft/duroxide) -  (2 days ago)
