...
- [zph/signalk-bathymetry](https://github.com/zph/signalk-bathymetry) -  (4 days ago)
- [zph/signalk-constants](https://github.com/zph/signalk-constants) - Publish user-configured constant values to Signal K (4 days ago)
...
- [zph/terraform-provider-mongodb](https://github.com/zph/terraform-provider-mongodb) ([v0.5.0](https://github.com/zph/terraform-provider-mongodb/releases/tag/v0.5.0), 2 days ago) - MongoDB Terraform Provider
...
- [seandepagnier/weather_routing_pi](https://github.com/seandepagnier/weather_routing_pi) - weather routing plugin for opencpn (3 days ago)
- [rgleason/weather_routing_pi](https://github.com/rgleason/weather_routing_pi) - Weather Routing plugin for OpenCPN (3 days ago)
- [matztam/signalk-beluga-core](https://github.com/matztam/signalk-beluga-core) - A SignalK plugin that emulates an ORCA Core marine sensor hub. It makes the ORCA app connect to your SignalK server. (4 days ago)
