...
- [jdx/mise](https://github.com/jdx/mise) ([v2024.6.3](https://github.com/jdx/mise/releases/tag/v2024.6.3), 1 day ago) - dev tools, env vars, task runner
...
- [teodevgroup/teo](https://github.com/teodevgroup/teo) - Schema-driven web server framework. (2 days ago)
- [batfish/batfish](https://github.com/batfish/batfish) - Batfish is a network configuration analysis tool that can find bugs and guarantee the correctness of (planned or current) network configurations. It enables network engineers to rapidly and safely evolve their network, without fear of outages or security breaches. (2 days ago)
- [areguera/terraform-aws-ssm](https://github.com/areguera/terraform-aws-ssm) - Terraform module to compose AWS Systems Manager (SSM) configurations (4 days ago)
