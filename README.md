...
- [2024 State of the Union](https://blog.xargs.io/post/2024-08-06-2024-state-of-the-union/) (4 weeks ago)
- [Improved e2e testing by replacing bats-core with deno&#43;dax](https://blog.xargs.io/post/2024-08-06-improved-e2e-testing-by-replacing-bats-core-with-deno-dax/) (4 weeks ago)
...
- [denoland/deno](https://github.com/denoland/deno) ([v1.46.2](https://github.com/denoland/deno/releases/tag/v1.46.2), 6 days ago) - A modern runtime for JavaScript and TypeScript.
- [jdx/mise](https://github.com/jdx/mise) ([v2024.8.15](https://github.com/jdx/mise/releases/tag/v2024.8.15), 6 days ago) - dev tools, env vars, task runner
- [dagu-org/dagu](https://github.com/dagu-org/dagu) ([v1.14.3](https://github.com/dagu-org/dagu/releases/tag/v1.14.3), 3 weeks ago) - Developer-friendly, minimalism Cron alternative, but with much more capabilities. It aims to solve greater problems.

#### 🔨 My recent Pull Requests

- [Zero args to the wrapper means call help](https://github.com/zph/tome-cli/pull/11) on [zph/tome-cli](https://github.com/zph/tome-cli) (3 weeks ago)
- [Speed improvements on parsing usage and help](https://github.com/zph/tome-cli/pull/10) on [zph/tome-cli](https://github.com/zph/tome-cli) (3 weeks ago)
- [Respect SUMMARY: or USAGE:](https://github.com/zph/tome-cli/pull/5) on [zph/tome-cli](https://github.com/zph/tome-cli) (4 weeks ago)
...
- [will-moss/isaiah](https://github.com/will-moss/isaiah) - Self-hostable clone of lazydocker for the web. Manage your Docker fleet with ease (1 week ago)
...
- [youtube/doorman](https://github.com/youtube/doorman) - Doorman: Global Distributed Client Side Rate Limiting. (1 week ago)
