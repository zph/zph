...
- [ZStud/reef](https://github.com/ZStud/reef) - Paste bash into fish. It just works. (1 day ago)
- [jingkaihe/matchlock](https://github.com/jingkaihe/matchlock) - Matchlock secures AI agent workloads with a Linux-based sandbox. (3 days ago)
- [simplyblock/vela](https://github.com/simplyblock/vela) - Postgres Backend Platform with full stack (auth, APIs, functions), instant cloning, branching and separation of compute and storage. Built for self-hosting. (3 days ago)
