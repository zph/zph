...
- [dagu-org/dagu](https://github.com/dagu-org/dagu) ([v1.16.10](https://github.com/dagu-org/dagu/releases/tag/v1.16.10), 1 day ago) - A compact, portable, and language-agnostic workflow engine. It aims to solve greater problems.
- [denoland/deno](https://github.com/denoland/deno) ([v2.3.3](https://github.com/denoland/deno/releases/tag/v2.3.3), 1 day ago) - A modern runtime for JavaScript and TypeScript.
...
- [meri-imperiumi/signalk-audio-notifications](https://github.com/meri-imperiumi/signalk-audio-notifications) - Spoken audio for Signal K alerts using text-to-speech (1 day ago)
...
- [Allopart/Maritme_Mask_RCNN](https://github.com/Allopart/Maritme_Mask_RCNN) - Mask-RCNN applied to DTU Maritime dataset for the autonomous navigation of vessels through image segmentation (1 day ago)
