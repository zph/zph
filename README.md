...
- [jdx/mise](https://github.com/jdx/mise) ([v2024.9.0](https://github.com/jdx/mise/releases/tag/v2024.9.0), 3 days ago) - dev tools, env vars, task runner
- [denoland/deno](https://github.com/denoland/deno) ([v1.46.3](https://github.com/denoland/deno/releases/tag/v1.46.3), 4 days ago) - A modern runtime for JavaScript and TypeScript.
...
- [Zh r3.0.62 temp](https://github.com/zph/terraform-provider-mysql/pull/8) on [zph/terraform-provider-mysql](https://github.com/zph/terraform-provider-mysql) (3 days ago)
