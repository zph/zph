...
- [CITGuru/openduck](https://github.com/CITGuru/openduck) - Distributed DuckDB - dual execution and differential storage (1 day ago)
- [ilum-cloud/duck_lineage](https://github.com/ilum-cloud/duck_lineage) - A extension for DuckDB, which captures lineage events for executed queries (1 day ago)
- [stablyai/orca](https://github.com/stablyai/orca) - Orca is the next-gen IDE for building with coding agents (2 days ago)
