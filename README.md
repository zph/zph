...
- [agentika-labs/grepika](https://github.com/agentika-labs/grepika) -  (2 days ago)
- [mickamy/sql-tap](https://github.com/mickamy/sql-tap) - Watch SQL traffic in real-time with a TUI (2 days ago)
